...
const included = [
  "The ₦10,000 Investment Blueprint (core guide)",
  "Investment Starter Checklist",
  "Trusted Investment Platforms Directory",
  "Investment Allocation Template",
  "Investment Goal Planner",
  "Lifetime access to the investment community",
];

export default function InvestmentBlueprintCheckout() {
  ...
  async function handlePay(e: React.FormEvent) {
    ...
    setLoading(true);
    try {
      const res = await fetch("/api/products/investment-blueprint/pay", {
        method: "POST",
  ...
  return (
    <div style={{ minHeight: "100vh", backgroundColor: "#F7F5EF", color: "#0C1220", padding: "48px 16px" }}>
      <div style={{ maxWidth: "960px", margin: "0 auto" }}>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "32px", alignItems: "start" }}>

          {/* ── Left: What You Will Get ── */}
          <div>
            <h2 style={{ fontSize: "24px", fontWeight: 700, color: "#02133B", textAlign: "center", marginBottom: "24px" }}>
              The Investment Starter Kit
            </h2>

            <div style={{ borderRadius: "12px", padding: "24px", backgroundColor: "#02133B", color: "#fff" }}>
              <p style={{ fontSize: "13px", color: "rgba(255,255,255,0.55)", marginBottom: "4px" }}>Total value</p>
              <p style={{ fontSize: "28px", fontWeight: 700, color: "#F8D300", margin: 0 }}>₦110,000+</p>
            </div>
          ...
          <div style={{ borderRadius: "12px", overflow: "hidden", boxShadow: "0 4px 24px rgba(0,0,0,0.10)", border: "1px solid #e5e7eb" }}>
            ...
            {/* Navy header banner */}
            <div style={{ backgroundColor: "#02133B", padding: "24px", textAlign: "center" }}>
              ...
              <p style={{ color: "rgba(255,255,255,0.75)", fontSize: "13px", marginTop: "6px" }}>
                Get instant access to the Investment Blueprint!
              </p>
            </div>
            ...
            <div style={{ backgroundColor: "#ffffff", padding: "28px 24px" }}>
              ...
              <form onSubmit={handlePay} style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
                ...
                <button
                  ...
                  style={{
                    width: "100%",
                    backgroundColor: loading ? "#6b7280" : "#02133B",
                    color: "#ffffff",
                    fontWeight: 700,
                    fontSize: "15px",
                    padding: "14px",
