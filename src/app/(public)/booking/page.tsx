  ...
  return (
    <div className="bg-white dark:bg-[#0a0d14]">
      ...
      <section className="px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Contained hero card */}
        <div className="relative mx-auto max-w-6xl min-h-[580px] flex items-center rounded-3xl overflow-hidden">
          ...
          {/* Content grid */}
          <div className="relative w-full px-8 sm:px-12 py-16 grid lg:grid-cols-[1fr_420px] gap-10 items-center">
