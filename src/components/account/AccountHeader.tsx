...
export default function AccountHeader({
  ...
  return (
    <header className="flex items-center justify-between border-b border-gray-200 dark:border-white/10 bg-white dark:bg-[#10141c] px-6 md:px-10 h-[68px] shrink-0">
      {/* Left */}
