...
export default function StockTicker() {
  ...
  return (
    <div className="w-full bg-[#0d0f14] border-b border-white/5 overflow-hidden flex items-stretch h-9 select-none">
      {/* NGX LIVE badge */}
      <div className="flex items-center gap-1.5 px-3.5 shrink-0 bg-[#111318] border-r border-white/5 z-10">
      ...
      <div className="flex-1 overflow-hidden relative">
        {/* Fade edges */}
        <div className="pointer-events-none absolute left-0 top-0 h-full w-12 bg-gradient-to-r from-[#0d0f14] to-transparent z-10" />
      ...
      {/* DELAYED badge */}
      <div className={`flex items-center px-3.5 shrink-0 bg-[#111318] border-l border-white/5`}>
